...
static int parse_options(int argc, char **argv, struct swaylock_state *state,
  ...
  static struct option long_options[] = {
      ...
      {"caps-lock-bs-hl-color", required_argument, NULL,
       LO_CAPS_LOCK_BS_HL_COLOR},
      {"caps-lock-key-hl-color", required_argument, NULL,
       LO_CAPS_LOCK_KEY_HL_COLOR},
      ...
      {"inside-caps-lock-color", required_argument, NULL,
       LO_INSIDE_CAPS_LOCK_COLOR},
      ...
      {"line-caps-lock-color", required_argument, NULL,
       LO_LINE_CAPS_LOCK_COLOR},
      ...
      {"ring-caps-lock-color", required_argument, NULL,
       LO_RING_CAPS_LOCK_COLOR},
      ...
      {"text-caps-lock-color", required_argument, NULL,
       LO_TEXT_CAPS_LOCK_COLOR},
...
int main(int argc, char **argv) {
  ...
  if (username) {
    state.username.buf = username;
    state.username.len = strlen(username);
  } else {
    state.username.buf = "user";
